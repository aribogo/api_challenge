package gft.api.DTO.politician;

import gft.api.DTO.image.ImageDTO;
...
public class PoliticianDTO {
	...
	public PoliticianDTO(String name, String position, String partyDTO, Integer lawproject, Integer process,
